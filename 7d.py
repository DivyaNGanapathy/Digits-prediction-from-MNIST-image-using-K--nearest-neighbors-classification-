'''
7d. Code to plot for varied values of k.
'''
...
train_images = images_train[0:1000, :]
train_labels = labels_train[0:1000]

# if you want to use only the first 1000 data points.
test_images = images_test[0:100, :]
test_labels = labels_test[0:100]
...
def plot_acc_for_k(train_images, train_labels, test_images, test_labels, k):
    training_count = [30, 100, 500, 1000]
...
plt.title("Avg accuracy for varied k")
plt.show()